...
class StatiChart12 extends React.Component {
  componentDidMount() {
    const chart = am4core.create('chartdiv12', am4charts.XYChart);
    ...
    series.heatRules.push({
      target: bullet, min: 2, max: 60, property: 'radius'
    });
